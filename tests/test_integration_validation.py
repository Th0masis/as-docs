...
class TestEdgeCases:
    ...
    def test_as_cli_timeout_fallback(self):
        ...
        with patch("as_docs.scanner.as_cli_adapter.AsCliAdapter") as MockAdapter:
            ...
            mock_adapter.get_logical_list.side_effect = AsCliTimeoutError("Command timeout after 100ms")
    ...
    def test_as_cli_daemon_start_failure(self):
        ...
        with patch("as_docs.scanner.as_cli_adapter.AsCliAdapter") as MockAdapter:
            ...
            mock_adapter._ensure_daemon.side_effect = AsCliError("Failed to start daemon")
    ...
    def test_as_cli_partial_command_failure(self):
        ...
        with patch("as_docs.scanner.as_cli_adapter.AsCliAdapter") as MockAdapter:
            ...
            mock_adapter.get_symbol_search.side_effect = AsCliError("symbol_search not available")
    ...
    def test_as_cli_invalid_json_response(self):
        ...
        with patch("as_docs.scanner.as_cli_adapter.AsCliAdapter") as MockAdapter:
            ...
            mock_adapter.get_logical_list.side_effect = AsCliParseError("Invalid JSON response")
